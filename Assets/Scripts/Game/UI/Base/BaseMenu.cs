...
namespace Assets.Scripts.Game.UI.Base
{
    ...
    public abstract class BaseMenu : MonoBehaviour
    {
        ...
        {
            // Try to find CanvasGroup on the assigned UI object, fallback to self
        ...
        protected void ShowMenu(string statusMessage = null, bool pauseTime = true)
        {
            ...
            if (_canvasGroup != null)
            {
                ...
                _canvasGroup.DOFade(1f, _fadeDuration)
                    ...
                    .SetUpdate(true) // Important for when Time.timeScale is 0
        ...
        protected void HideMenu(bool resumeTime = true)
        {
            ...
            if (_canvasGroup != null)
            {
                ...
                _canvasGroup.blocksRaycasts = true; // Block clicks during fade out
